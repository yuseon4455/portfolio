...
const Project = () => {
  ...
  const projectImages = {
    rocketbook: [
      { src: '/images/studyo-main.png', alt: 'JavaNyang 메인 화면' },
      { src: '/images/studyo-main.png', alt: 'JavaNyang 메인 화면' },
      { src: '/images/studyo-main.png', alt: 'JavaNyang 메인 화면' },
      { src: '/images/studyo-main.png', alt: 'JavaNyang 메인 화면' },
    ],
    ...
    <section className="page page-05 active" id="page-05">
      ...
      <div className="project-grid">
        ...
        <div className="project-card">
          ...
          <div className="project-features">
            <ul>
              <li>스터디 그룹 CRUD(생성·조회·수정·삭제) 기능 구현</li>
              <li>S3 기반 썸네일 업로드 및 관리 기능 개발</li>
              <li>React + Spring Boot를 연동하여 프론트엔드·백엔드 전체 흐름 구현</li>
              <li>폼 유효성 검증 및 사용자 경험 개선 (중복 검사, 기본 이미지 처리, 입력 제한 등)</li>
          ...
          <div className="project-buttons">
            ...
            <button className="btn btn-image" onClick={() => openImageModalHandler('studyO')}>이미지</button>
            <button
              className="btn btn-ppt"
