...
const ReadmeModal = ({ openModal, closeModal, cardPosition }) => {
  useEffect(() => {
    if (openModal) {
  ...
  return (
    ...
    >
      <div
        className="project-readme-modal-content"
        style={{
          position: 'fixed',
      ...
      >
        <span className="project-readme-close-btn" onClick={closeModal}>&times;</span>
        ...
        {openModal === 'rocketbook' && (
          <div className='project-modal-content-wrapper'>
            ...
            <h3>프로젝트 의의</h3>
            <p>기존 온라인 서점과 차별화된 배송 시스템을 기획하고 구현함으로써, 
              실제 서비스 기획부터 개발까지의 전 과정을 경험할 수 있었습니다. 
              특히 팀 협업을 통해 대규모 웹 애플리케이션 개발 경험을 쌓고, 사용자 중심의 서비스 설계 능력을 기를 수 있었습니다.
            </p>
        ...
        {openModal === 'javaNyang' && (
          <div className='project-modal-content-wrapper'>
            ...
            <p><a href="https://github.com/hyunsupLee/JavaNyang" target="_blank">GitHub 저장소 바로가기</a></p>
          </div>
        )}
        ...
        {openModal === 'studyO' && (
          <div className='project-modal-content-wrapper'>
            ...
            <p><strong>소개:</strong> React와 Spring Boot를 활용한 풀스택 스터디 모집 플랫폼입니다. 
              다양한 분야의 스터디 그룹을 생성하고 참여할 수 있는 종합적인 학습 커뮤니티 서비스를 구현했습니다.
            </p>

            <h3>프로젝트 배경</h3>
            <p>개인 학습의 한계를 극복하고 함께 성장할 수 있는 스터디 문화를 만들기 위해 기획된 프로젝트입니다. 
              사용자들이 쉽게 스터디를 개설하고 참여할 수 있는 직관적인 플랫폼을 목표로 개발했습니다.
            </p>
            ...
            <p>대규모 팀 프로젝트를 통해 실무와 유사한 개발 환경에서의 협업 경험을 쌓을 수 있었습니다. 
              특히 프론트엔드와 백엔드 간의 API 연동, 상태 관리, 
              그리고 사용자 경험을 고려한 인터페이스 설계에 대한 깊은 이해를 얻었습니다.
            </p>

            <p><a href="https://www.studyo.r-e.kr/" target="_blank">사이트 바로가기</a> | <a href="https://github.com/hyunsupLee/react-study-o" target="_blank">GitHub 저장소</a></p>
          </div>
        )}
        ...
        {openModal === 'ashley' && (
          <div className='project-modal-content-wrapper'>
            ...
            <p><strong>소개:</strong> Ashley 가구 브랜드의 공식 웹사이트를 분석하고 전체적인 구조와 UI를 
            새롭게 리디자인한 캡스톤 프로젝트입니다. 기존 사이트의 장점을 유지하면서 더 나은 사용자 경험을 제공하는 것을 목표로 했습니다.
            </p>

            <h3>프로젝트 배경</h3>
            <p>Ashley Furniture의 기존 웹사이트를 철저히 분석하여 사용성 개선점을 찾고, 
              이를 바탕으로 전면적인 리디자인을 진행했습니다. 
              가구 브랜드의 특성을 살린 시각적 매력과 직관적인 네비게이션 구조에 중점을 두었습니다.
            </p>
            ...
            <p>실제 기업의 웹사이트를 분석하고 개선하는 과정을 통해 상용 웹사이트 개발에 
              필요한 전반적인 기술과 사용자 경험 설계 능력을 기를 수 있었습니다. 
              또한 브랜드 가이드라인을 준수하면서도 창의적인 해결책을 제시하는 능력을 개발했습니다.
            </p>
        ...
        {openModal === '20century' && (
          <div className='project-modal-content-wrapper'>
            ...
            <p><strong>소개:</strong> 20세기를 테마로 한 영화 소개 웹사이트입니다. 
            모바일 앱 UI를 웹으로 구현하여 사용자 친화적인 인터페이스로 영화 정보를 제공합니다.
            </p>

            <h3>프로젝트 배경</h3>
            <p>20세기의 클래식 영화들을 소개하는 정적 웹사이트를 제작했습니다. 
              모바일 앱의 직관적인 UI/UX를 웹 환경에 적용하여 사용자가 쉽게 영화 정보를 탐색할 수 있도록 설계했습니다.
            </p>
            ...
            <h3>배운 점</h3>
            <p>팀 프로젝트를 통해 협업 능력을 기르고, 모바일 앱의 사용성을 웹에 적용하는 경험을 쌓을 수 있었습니다. 
              또한 콘텐츠 중심의 웹사이트 설계와 사용자 경험 최적화에 대해 깊이 있게 학습했습니다.</p>
        ...
        {openModal === 'animal' && (
          <div className='project-modal-content-wrapper'>
            ...
            <p><strong>소개:</strong> HTML, CSS, JavaScript, jQuery를 활용해 동물병원 협회 웹사이트를 정적 페이지로 구현한 프로젝트입니다. 
            기존 협회 웹사이트의 구조를 분석하고 사용자 경험을 개선한 리디자인 작업을 진행했습니다.</p>

            <h3>프로젝트 배경</h3>
            <p>실제 동물병원 협회 홈페이지의 구조 및 콘텐츠를 기반으로 클론 및 개선 작업을 진행했습니다. 
              협회의 정체성을 유지하면서도 더 나은 사용자 경험을 제공하는 웹사이트 구축을 목표로 했습니다.</p>
            ...
            <h3>프로젝트를 통해 배운 점</h3>
            <p>웹 퍼블리싱의 기초를 다지고, 팀워크를 통한 협업 능력을 기를 수 있었던 의미 있는 프로젝트였습니다. 
              특히 실제 존재하는 웹사이트를 분석하고 개선하는 과정에서 사용자 중심의 웹 개발 사고방식을 기를 수 있었으며, 
              jQuery를 활용한 동적 요소 구현 경험을 쌓을 수 있었습니다.</p>
